...
public class RunClient {
    public static void main(String[] args) {
        try {
            ...
            Registry registry = LocateRegistry.getRegistry(host,10990);
            ...
            if(c.isRegistered()) {
                ...
                System.out.println("Type 7 followed by your message to send a message to the chat room and press Enter");
